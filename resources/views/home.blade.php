...
<div class="super_container">
	...
	<div class="container text-light">
		<div class="row text-light">
			<div class="col-sm d-flex justify-content-center text-light">
				<div class="form-group">
					<input class="form-check-input radiobtn" name="group100" type="radio" id="radio100" selected checked value="0">
					<label for="radio100" class="form-check-label text-light">All</label>
				</div>
			</div>
			  ...
			  @if ($item->product->count())
				  <div class="col-sm d-flex justify-content-center text-light">
					<div class="form-group">
						  ...
						  <label for="radio10{{$loop->iteration}}" class="form-check-label text-light">{{$item->category_name}}</label>
					  </div>
				  </div>
			  @else
						...
						<div class="product">
							...
							@endif
								<div class="product_content">
									<div class="product_title"><a class="text-light" href="/product/{{$products->id}}">{{$products->product_name}}</a></div>
									...
									@endif	
										...
										@endphp
										@if ($harga != 0)	   
											<div style="text-decoration:line-through;" class="product_price text-light">Rp.{{number_format($products->price)}}</div>
											<div style="font-weight:bold;" class="product_price text-light">Rp.{{number_format($harga)}}</div>
										@else
											<div class="product_price text-light">Rp.{{number_format($products->price)}}</div>
										@endif
								</div>
						</div>
						@endforeach
			...
			<div class="row icon_box_row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						...
						<div class="icon_box_title text-light">Free Shipping Worldwide</div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						...
						<div class="icon_box_title text-light">Free Returns</div>
						<div class="icon_box_text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a ultricies metus. Sed nec molestie.</p>
						</div>
					</div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						...
						<div class="icon_box_title text-light">24h Fast Support</div>
						<div class="icon_box_text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a ultricies metus. Sed nec molestie.</p>
						</div>
					</div>
