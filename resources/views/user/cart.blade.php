...
<div style="background-color: #333333" class="home">
	...
	<!-- Cart Info -->
	<div style="background-color: #333333" class="cart_info ganti">
		<div class="container">
			<div class="row">
				<div class="col">
					<!-- Column Titles -->
					...
					<div class="cart_item d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
						...
						<div class="cart_item_product d-flex flex-row align-items-center justify-content-start">
							...
							<div class="cart_item_name_container">
								<div class="cart_item_name"><a class="text-light" href="#">{{$isi->product->product_name}}</a></div>
								<div class="cart_item_edit"><a class="text-light" href="#">Edit Product</a></div>
							</div>
						</div>
						<!-- Price -->
						@php
						...
						@endphp
						@if ($harga != 0)
						<div class="cart_item_price text-light">
							Rp.<span class="float-lef text-light price{{$loop->iteration-1}}">{{$harga}}</li>
							Rp.<span class="float-lef text-light"><small><s>{{$isi->product->price}}</s></small></span>
						</div>
						@else
							<div class="cart_item_price text-light">
								Rp.<span class="float-lef text-light price{{$loop->iteration-1}}">{{$isi->product->price}}</li>
							</div>
						@endif
						<!-- Quantity -->
						...
						@if ($harga != 0)
                        	...
                        	@endphp
                    	@else
                        	<strong class="cart_item_total text-light sub-total{{$loop->iteration-1}}">{{$isi->product->price*$isi->qty}}</strong>
                        	@php
